...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    $atualiza = new Artigo($mysql);
    $atualiza->editaArtigo($_POST['id'], $_POST['titulo'], $_POST['conteudo']);

    redirecionaPagina("http://localhost/blog/admin/");

}

$editaArtigo = new Artigo($mysql);
$art = $editaArtigo->recuperaArtigo($_GET['id']);
...
<body>
    <div id="container">
        ...
        <form action="editar-artigo.php" method="post">
            ...
            <p>
                <button class="botao">Atualiza Artigo</button>
            </p>
        </form>
    </div>
</body>
